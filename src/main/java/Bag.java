...
public abstract class Bag {
    ...
    public void addItem(String item) {
        if (this.numberOfContents < this.capacity) {
            int length = this.numberOfContents;
            String[] temp = this.contents;
            this.contents = new String[length + 1];
            System.arraycopy(temp, 0, this.contents, 0, length);
            this.contents[length] = item;
    ...
    public String popItem() {
        ...
        String[] temp = this.contents;
        this.contents = new String[length - 1];
        System.arraycopy(temp, 0, this.contents, 0, length - 1);
        this.numberOfContents -= 1;
    ...
    public void increaseCapacity(int n) {
        ...
        System.arraycopy(temp, 0, this.contents, 0, this.numberOfContents);
    }
